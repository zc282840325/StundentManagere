	...
	<div style="width: 100%;">
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
		      <el-form :inline="true">
		        ...
		        <el-form-item>
		         <router-link to="/UserAU"> <el-button type="primary">新增</el-button></router-link>
		        </el-form-item>
		      </el-form>
		    </el-col>
	    <el-main>
		 ...
		 <el-table-column label="操作">
		                    <template slot-scope="scope">
								<!-- 授权按钮-->
								<el-button type="primary" icon="el-icon-open" size="mini" @click="authorizeUserDialog(scope.row.Id)"></el-button>
		                        <!-- 修改按钮 -->
  ...
  export default {
	...
	methods: {
	     async getUsers(page,size) { 
	       ...
	       await this.axios.get('/Users?page='+page+'&pagesize='+size).then((response) => {
		  ...
		  showEditDialog(data){
			  this.$router.push({ path: '/UserAU/'+data });
		  },
		  authorizeUserDialog(data)
		  {
			    this.$router.push({ path: '/UserRole/'+data });
		  },
